...
<s:form action="Employee_addEmployee" method="post" namespace="/employeeManager" id='addForm'>
...
<tr>
<td>所属部门：</td>
<td><s:select name="department.did" list="list" listKey="did" listValue="dname" headerKey="" headerValue="请选择"></s:select>
</td>
